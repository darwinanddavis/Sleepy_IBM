...
;  search-energy      ; Minimum reserve that satisficing individual reaches to stop resting and start searching. Defined in Setup as fraction of total reserve. This is the crux of the satisficing strategy--rest only until food is needed.
  ...
  T_opt_lower        ; Lower foraging body temperature of individual (Celcius)
  T_opt_upper        ; Upper foraging body temperature of individual (Celcius)
...
"Min-T_b" 1.0 0 -2674135 true "auto-plot-off\nplotxy 0 min-T_b\nplotxy 1000000000 min-T_b\nauto-plot-on" ""
"Max-T_b" 1.0 0 -2674135 true "auto-plot-off\nplotxy 0 max-T_b\nplotxy 1000000000 max-T_b\nauto-plot-on" ""
